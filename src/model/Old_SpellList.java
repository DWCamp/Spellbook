 ...
 * @author Daniel
 */
public class Old_SpellList implements Serializable {

	private static Map<String, Spell_FE> allFESpells = new HashMap<>();
	private static Map<String, Spell_FE> FEcantrips = new HashMap<>();
	private static Map<String, Spell_FE> FEfirstLevel = new HashMap<>();
	private static  Map<String, Spell_FE> FEsecondLevel = new HashMap<>();
	private static  Map<String, Spell_FE> FEthirdLevel = new HashMap<>();
	private static  Map<String, Spell_FE> FEfourthLevel = new HashMap<>();
	private static  Map<String, Spell_FE> FEfifthLevel = new HashMap<>();
	private static  Map<String, Spell_FE> FEsixthLevel = new HashMap<>();
	private static  Map<String, Spell_FE> FEseventhLevel = new HashMap<>();
	private static  Map<String, Spell_FE> FEeighthLevel = new HashMap<>();
	private static  Map<String, Spell_FE> FEninthLevel = new HashMap<>();
	...
	private static Map<String, Spell_FE> customFESpells = new HashMap<>();
	private static ArrayList<Map<String, Spell_FE>> FElistList = new ArrayList<>();
	
	private static Map<String, Spell_PF> allPFSpells = new HashMap<>();
	private static ArrayList<Map<String, Spell_PF>> PFalphabetList = new ArrayList<>();
