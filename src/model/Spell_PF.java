...
public class Spell_PF extends Spell implements Comparable<Spell_PF>{
	String name;
	String school;
	String[] subschools;
	String[] descriptors;
	 ...
	 */
	public Spell_PF(String name, String school, String[] subschools, String[] descriptors, HashMap<String,Integer> classes,
	 ...
	 */
	@Override
	public int compareTo(Spell_PF other) {
